<nav id="sidebar" role="navigation" data-step="2" data-intro="Template has <b>many navigation styles</b>" data-position="right" class="navbar-default navbar-static-side" style="min-height: 100%;">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
					...
					<li><a href="clients.php"><i class="fa fa-users fa-fw">
                        <div class="icon-bg bg-pink"></div>
                    </i><span class="menu-title">Clients</span></a>
                       
                    </li>
					
                    <li><a href="drivers.php"><i class="fa fa-car fa-fw">
                        <div class="icon-bg bg-green"></div>
                    </i><span class="menu-title">Drivers</span></a>
                       
                    </li>
					
                    <li><a href="reports.php"><i class="fa fa-edit fa-fw">
                        <div class="icon-bg bg-violet"></div>
                    </i><span class="menu-title">Reports</span></a>
                      
                    </li>
					
                    <li><a href="account.php"><i class="fa fa-th-list fa-fw">
